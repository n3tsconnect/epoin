...
<table id="bootstrap-data-table2" class="table table-striped table-bordered" style="overflow:auto;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php if (strtotime($pelanggaran["sampai_kapan"]) >= time()) { echo gmdate("H:i:s", strtotime($pelanggaran["sampai_kapan"]) - time()); } else { echo gmdate("H:i:s", strtotime("00:00:00") + 1); } ?></td>
