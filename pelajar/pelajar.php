            ...
            <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="col-lg-3">
                                <img style="width:150px; height:150px;" src="<?php if ($pelajar['foto_pelajar'] == "") { echo 'https://placekitten.com/g/200/200';; } else { echo '../gambar/profil/pelajar/'.$pelajar['foto_pelajar'].'';} ?>"/>
                                </div>
                                <div class="col-lg-3">
